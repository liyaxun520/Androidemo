...
public class ProgressDownSubscriber<T> extends Subscriber<T> implements DownloadProgressListener {
    ...
    /*下载数据*/
    private DownInfoEntity downInfo;
    private Handler handler;


    public ProgressDownSubscriber(DownInfoEntity downInfo,Handler handler) {
    ...
    public void setDownInfo(DownInfoEntity downInfo) {
        this.mSubscriberOnNextListener = new SoftReference<>(downInfo.getListener());
        this.downInfo=downInfo;
    }
    ...
    public void onCompleted() {
        ...
        AppDataBase.getInstance().getDownloadDao().update(downInfo);
    }
