package com.decard.mvpframe.base.activity;

import android.os.Bundle;
import android.support.annotation.NonNull;

import com.decard.mvpframe.base.BasePresenter;
import com.decard.mvpframe.base.IBaseActivity;
...
public abstract class BaseMVPCompatActivity<P extends BasePresenter> extends
    ...
    protected void onDestroy() {
        ...
        if (mPresenter != null) {
            mPresenter.detachMV();
            //LogUtils.trace("detach M V success.");
        }
    }
