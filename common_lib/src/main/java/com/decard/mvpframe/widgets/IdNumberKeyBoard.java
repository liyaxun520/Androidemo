...
public class IdNumberKeyBoard extends KeyboardView implements KeyboardView.OnKeyboardActionListener {
    //数字键盘
    ...
    public IdNumberKeyBoard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IdNumberKeyBoard(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setAttachToEditText(EditText et) {
        ...
        if (keyboard == null) {
            keyboard = new Keyboard(getContext(), R.xml.idkeyboard);
        }
        this.editText = et;
