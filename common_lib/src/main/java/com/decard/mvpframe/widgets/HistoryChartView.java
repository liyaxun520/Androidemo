...
import com.decard.mvpframe.utils.DisplayUtils;
...
public class HistoryChartView extends View {
    ...
    public HistoryChartView(Context context, AttributeSet attrs,
        ...
        //LogUtils.trace("HistoryChartView(Context context, AttributeSet attrs, int defStyleAttr)");
    ...
    public void setData(String strAlldata, int mode) {
        //LogUtils.trace("history chart view strAlldata = " + strAlldata);
